...
export const prBarProfileQ1Per = 20;
export const profileQ1Form = 'profile_questions_1';
export const profileQ1HR = 'hourly_rate';
export const profileQ1Descr = 'description';
